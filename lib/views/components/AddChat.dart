...
import 'package:converter_ios_and/controllers/providers/chat_provider.dart';
import 'package:converter_ios_and/models/controller.dart';
                ...
                child: Column(
                  children: [
                    ...
                    OutlinedButton(
                      onPressed: () {
                        print("----");
                        var acp = Provider.of<AddChatProvider>(context,
                            listen: false);

                        print(acp.addChatModel.img);
                        print(acp.addChatModel.pickDate);
                        print(acp.addChatModel.pickTime);
                        print( Provider.of<AddChatProvider>(context,listen: false).addChatModel.pickTime);

                        if ((formKey.currentState?.validate() ?? false) &&
                            acp.addChatModel.pickDate != null &&
                            acp.addChatModel.pickTime != null) {
                          print("object");
                          Provider.of<AddChatProvider>(context, listen: false)
                              .saveChat();
                        } else {
